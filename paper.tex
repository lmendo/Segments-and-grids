...
\end{equation}
with **define i+, such that i* = round-half-up(i+), and similarly for j+**
\begin{align}
...
\funl(\tiles) = \sqrt{\frac{(t-3) a^2 b^2}{a^2+b^2} + \roundterm^2(a^2+b^2)}
\end{equation}
with
\begin{equation}
\label{eq: roundterm}
...
***Proof of new formula. I think it's better to do it once the proof of \ref{prop: min suff set, form} is done.
