...
The problems studied in this paper are related to \ldots ***maybe a short paragraph here mentioning related problems: Buffon's needle, Buffon-Laplace problem. Some references: \cite{Ramaley69}, \cite{Arnow94}, \cite{Mathai99}.
...
\begin{proof}
% ***AA: Is this writeup too informal/non-rigorous?
% ***LM: \cite{Ramaley69} already gives the $2\len/(\pi a)$ formula. We can directly start from that formula, referencing that paper, which simplies the proof.
