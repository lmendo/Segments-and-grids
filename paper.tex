...
\begin{equation}
\label{eq: g def}
g(\genvar, u, v) = \frac 2 \pi \int_{\arcsin \frac u {\genvar}}^{\arccos \frac v {\genvar}} \left( \genvar \sin \theta - u \right) \left( \genvar \cos \theta - v \right) \diff \theta.
\end{equation}
...
2\left(\arccos\frac{v}{\genvar}-\arcsin\frac{u}{\genvar}\right) u v + \genvar^2 + u^2 + v^2 \\
...
\frac{\tiles-3} 2, \frac{\tiles-3}2  \right) \quad\ \text{for } \tiles \text{ odd, } \textstyle \len \in \left( \frac{\tiles-3}{\sqrt{2}}, \frac{\sqrt{(\tiles-5)^2+(\tiles-1)^2}} 2 \right] \\
\probmax(\len) & = g\left(\len, \frac{\tiles-3} 2, \frac{\tiles-3} 2 \right) + 2 g\left(\len, \frac{\tiles-5} 2, \frac{\tiles-1} 2 \right) \\
& \text{for } \tiles \text{ odd, } \textstyle \len \in \left (\frac{\sqrt{(\tiles-5)^2+(\tiles-1)^2}} 2,  \frac{\sqrt{(\tiles-3)^2+(\tiles-1)^2}} 2 \right] \\
\probmax(\len) & = 2 g\left(\len, \frac{\tiles-4} 2, \frac{\tiles-2} 2 \right) \quad \text{for } \tiles \text{ even, } \textstyle \len \in \left( \frac{\sqrt{(\tiles-4)^2+(\tiles-2)^2}} 2, \frac{\sqrt{(\tiles-6)^2+\tiles^2}} 2 \right] \\
\probmax(\len) & = 2 g\left(\len, \frac{\tiles-4} 2, \frac{\tiles-2} 2 \right) + 2 g\left(\len, \frac{\tiles-6} 2, \frac \tiles 2 \right) \\
...
\end{multline}
which is $2 g(\len, (\tiles-5)/2, (\tiles-1)/2)$. This proves the second equality in \eqref{eq: probmax}.
...
&\lim_{\tiles \rightarrow \infty}\, \tiles g\left(\frac{\sqrt{(\tiles-3)^2+(\tiles-1)^2}} 2, \frac{\tiles-3} 2, \frac{\tiles-3} 2 \right) \\
&\quad = \lim_{\tiles \rightarrow \infty}\, \tiles g\left(\frac{\sqrt{(\tiles-3)^2+(\tiles-1)^2}} 2, \frac{\tiles-5} 2, \frac{\tiles-1} 2 \right) = \frac 2 {3\pi},
\end{split}
\end{equation}
...
\lim_{\tiles \rightarrow \infty}\, \tiles g\left(\frac{\tiles-2}{\sqrt 2}, \frac{\tiles-4} 2, \frac{\tiles-2} 2 \right) =
\lim_{\tiles \rightarrow \infty}\, \tiles g\left(\frac{\tiles-2}{\sqrt 2}, \frac{\tiles-6} 2, \frac \tiles 2 \right)
= \frac 2 {3\pi},
\end{equation}
