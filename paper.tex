...
% ***Is "touch" a good word, i.e. does it suggest that the _interior_ of the square should be reached? Maybe "touch" suggests only the edge, like "touching" in 3D means only the surface. I think "visit" may be a better word
% ***"Lattice" better than "grid"?
