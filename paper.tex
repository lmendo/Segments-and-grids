...
% ***Is "touch" a good word, i.e. does it suggest that the _interior_ of the square should be reached? Maybe "touch" suggests only the edge, like touching" in 3D means only he surface. Perhaps "cover"? But the segment does not really "cover" the ssuare
