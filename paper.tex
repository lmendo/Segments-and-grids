...
\frac \len a \in \left( \frac{\tiles-3}{\sqrt{2}}, \frac{ \sqrt{(\tiles^2-2)^2+1}}{\sqrt{2}} \right].
\end{equation}
For $\tiles \geq 3$, $t$ even, $\funt(\len) = \tiles$ if and only if
\begin{equation}
\label{eq: square, even max tiles, lengths}
\frac \len a \in \left(\frac{ \sqrt{(\tiles^2-3)^2+1}}{\sqrt{2}}, \frac{\tiles-2}{\sqrt{2}} \right].
\end{equation}
