...
% ***Correct the two labels in the figure
\begin{figure}%
\centering%
...
\end{align}
which in case of tie takes the first of the two pairs indicated above. Combining \eqref{eq: prop: min suff set, form: isolr}--\eqref{eq: prop: min suff set, form: jsoli}
% *!*
...
% ***Correct two labels in each of the two graphs
\begin{figure}
\centering%
